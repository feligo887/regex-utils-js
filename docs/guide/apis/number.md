...
```js
import { largeNumberReg } from 'regex-utils-js';
...
```js
import { integerReg } from 'regex-utils-js';
...
```js
import { looseDecimalsReg } from 'regex-utils-js';
...
```js
import { strictDecimalsReg } from 'regex-utils-js';
